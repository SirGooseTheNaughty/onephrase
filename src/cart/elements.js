...
const createRowText = (textOption) => {
    const textElement = createElement('div', ['t706__product-title__option', 'text-controls__row-title']);
...
const createRowPlusMinus = (textOption, productIndex, row) => {
    ...
    const wrapper = createElement('div', ['t706__product-plusminus', 'text-controls__row-plus-minus']);
...
const createRowTotal = (productData, textOption) => {
    const textElement = createElement('div', ['t706__product-amount', 'text-controls__row-total']);
    const priceElement = createElement('div', ['t706__cartwin-prodamount-price', 'text-controls__row-total-price']);
    priceElement.textContent = `${productData.price * textOption.amount}`;
